...
function renderAbout() {
  return `
    <section class="code-page">
      ...
      <p class="lead">Я изучаю C++ через реальные проекты: игры, собственный движок, системные утилиты и низкоуровневые реализации. Опыт Steam Workshop помогает понимать графику и игровой пайплайн не только со стороны кода,
      но и со стороны создания контента.
      Мне всегда было интересно понимать, как устроены сложные технические системы. За время работы я успел столкнуться с разными направлениями: ремонтом и обслуживанием автомобилей, диагностикой и ремонтом компьютеров,
      а также обслуживанием техники горнолыжного комплекса, включая ратраки и снегоходы. Этот опыт научил меня быстро разбираться в незнакомых устройствах, искать причины неисправностей и доводить задачи до результата.
      Сейчас этот же подход я применяю в разработке на C++, постепенно углубляясь в архитектуру программ, графику и игровые технологии.</p>
  `;
}
