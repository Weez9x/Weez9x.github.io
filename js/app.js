...
function renderAbout() {
  return `
    <section class="code-page">
      ...
      <p class="lead">Я изучаю C++ через реальные проекты: игры, собственный движок, системные утилиты и низкоуровневые реализации. Опыт Steam Workshop помогает понимать графику и игровой пайплайн не только со стороны кода, но и со стороны создания контента.</p>
      <div class="content-card"><p class="code-comment">// current mission</p><p>Развивать портфолио, углубляться в OpenGL и архитектуру игровых движков, готовиться к работе C++ разработчиком.</p></div>
    </section>
  `;
}
